...
window.I18n_KO = {
  ...
  sysinfo: {
    title: '시스템 정보',
    description: '시스템 세부 정보, 저장소, 네트워크 및 성능 정보를 봅니다.',
    tab: { overview: '개요', storage: '저장소', network: '네트워크', display: '디스플레이', performance: '성능', about: '정보' },
    browserPlatform: '브라우저 및 플랫폼',
    browser: '브라우저',
    platform: '플랫폼',
    language: '언어',
    ...
    fileSystem: '파일 시스템',
    storageUsed: '사용된 저장소',
    estimatedQuota: '예상 할당량',
    percentUsed: '사용률',
    used: '사용됨',
    localStorage: '로컬 저장소',
    size: '크기',
    largestFiles: '가장 큰 파일',
    ...
    pageLoad: '페이지 로드',
    loadTime: '로드 시간',
    domReadyTime: 'DOM 준비 시간',
    timeSinceLoad: '로드 이후 시간',
    navigationType: '탐색 유형',
    browserDetails: '브라우저 세부 정보',
